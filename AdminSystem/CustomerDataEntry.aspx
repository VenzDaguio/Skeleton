...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="txtAddress" runat="server" style="z-index: 1; left: 8px; top: 50px; position: absolute; bottom: 768px; right: 392px;" Text="Customer Address" width="150px"></asp:Label>
