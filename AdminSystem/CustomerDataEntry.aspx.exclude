...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtSign" runat="server" style="z-index: 1; left: 102px; top: 158px; position: absolute; height: 28px; width: 136px;"></asp:TextBox>
        ...
        <p>
            &nbsp;</p>
        <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 291px; top: 14px; position: absolute" Text="Find" />
    </form>
</body>
</html>
